...
export class HomePage{
    ...
    async isUserLoggedIn(): Promise<boolean> {
        // wait briefly for logout link to appear after login navigation
        return await this.eleUtil.waitForElementVisible(this.logoutLink, 5000);
    }
    ...
    async doSearch(searchKey: string) {
        ...
        await this.eleUtil.waitForPageLoad('networkidle');
